...
/******************** SCREEN 2 *****************************************/
	...
	namespace.screen2 = [
		...
		{
			year: 1737,
			html: '<div class="screen2-1"><p>Carl Linneaus would describe 5476 animal species during his career, earning him #9 of the top authors to describe animal species since binomial nomenclature became the standard. </p></div>'
		}
	];
...
/*
	setTimeout(function(){
		...
		$('#howread-div').css('height',lheight + 'px');
		console.log(lheight);
	},1000);
*/
	...
	var legend_items = namespace.svg.selectAll('.legend-text,.legend-rect');
...
/******************** JSON IN DATA *****************************************/		
	...
	d3.json('js/top-25b.json',function(data){
		namespace.data = data;
		loader.hide();
